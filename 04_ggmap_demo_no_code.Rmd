...
mallorca_map <- get_stamenmap(
    bbox = c(left = 2.2164, bottom = 39.2745, right = 3.7174, top = 39.9568), #get this from openStreetMap
    maptype = "terrain",
    zoom = 10 #get this info from URL, this is level of detail, num of pixels
)
```
...
```{r}
mallorca_map <- get_stamenmap(
    bbox = c(left = 2.3132, bottom = 39.4672, right = 3.0637, top = 39.8082), 
    maptype = "terrain",
    zoom = 11
)
ggmap(mallorca_map) +
